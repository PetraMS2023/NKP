...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO subcategories (subcategory_name_ar, subcategory_name_en, main_category_id, subcategory_image)
    VALUES ('$subcategory_name_ar', '$subcategory_name_en', $main_category_id, '$image_path')";
