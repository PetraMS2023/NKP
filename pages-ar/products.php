...
<body>
                    ...
                    <div class="drop">
                        <a href="##">
                            <img class="lang" src="../media/icons/lang-white.png" alt="" />AR<img class="drop-icon"
                                src="../media/icons/arrow-lang.png" alt="" /></a>
                        <span class="dropMenu">
                            <a href="../pages/products.php"><img class="lang"
    ...
    <div class="landing-subitems">
        <div class="container">
            <div class="title btmAni2500">مفارش سفرة السعد</div>
        </div>
    </div>
    ...
    if ($sub_category) {
        $sub_category_name = htmlspecialchars($sub_category['subcategory_name_ar']);
    } else {
            ...
            <div class="items">
                <?php if (!empty($products)): ?>
                    <?php foreach ($products as $product): ?>
                        <div class="item">
                            <img src="<?php echo htmlspecialchars($product['product_image']); ?>" alt="<?php echo htmlspecialchars($product['product_name_ar']); ?>" />
                            <div class="description">
                                <div class="name"><?php echo htmlspecialchars($product['product_name_ar']); ?></div>
