      ...
      <div class="pageCont">
        ...
        <div class="conta p30">
          <form class="taIn">
            ...
            $sql = "SELECT id, full_name, email, message FROM messages";
            ...
            <table class="tg">
              ...
              <tbody>
                <?php foreach ($messages as $message) { ?>
                  <tr>
                    <td class="mw200"><?php echo htmlspecialchars($message['full_name']); ?></td>
                    <td class="mw200"><?php echo htmlspecialchars($message['email']); ?></td>
                    <td class="tools">
                      <img src="../media/icons/edit.png" alt="" class="edit" data-id="<?php echo $message['id']; ?>"
                        ...
                        <img src="../media/icons/delete.png" alt="" class="delete" data-id="<?php echo $message['id']; ?>">
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
...
<!-- Enail Pop Message  -->
<div class="mes" id="messagePopup" style="display: none;">
    <div class="p100">
        <div class="contactPop">
            <div class="er">
                <span>الاسم الكامل :</span>
                <span id="popupFullName">نص تجريبي</span>
            </div>
            <div class="er">
                <span>البريد الالكتروني :</span>
                <span id="popupEmail">test@email.com</span>
            </div>
            <div class="er flc">
                <span>الرسالة :</span>
                <p id="popupMessage">نص تجريبــــي نص تجريبــــي نص تجريبــــي نص تجريبــــي نص تجريبــــي نص تجريبــــي</p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var popupFullName = document.getElementById('popupFullName');
    ...
    deleteButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            if (confirm('هل أنت متأكد أنك تريد حذف هذه الرسالة؟')) {
                ...
                xhr.open("POST", "../../backend/data/delete_message.php", true);
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState == 4 && xhr.status == 200) {
                        ...
                        if (response.success) {
                            ...
                            alert('حدث خطأ أثناء الحذف: ' + response.error);
                        }
                    }
                };
                xhr.send("id=" + id);
