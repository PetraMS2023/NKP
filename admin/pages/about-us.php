...
<body>
  ...
  <div class="dcont">
    ...
    <div class="mainCont" id="main">
      ...
      $sql = "SELECT about_text_ar, about_text_en FROM about_us WHERE id = 1"; // افتراض أن هناك سجل واحد فقط في الجدول
      ...
      <form class="conta p30" method="POST" action="../../backend/data/update_about.php">
          <h3>تعديل من نحن :</h3>
          <textarea class="txtArea" name="about_text_ar" placeholder="من نحن باللغة العربية"><?php echo $about_text_ar; ?></textarea>
          <textarea class="txtArea" name="about_text_en" placeholder="من نحن باللغة الانجليزية"><?php echo $about_text_en; ?></textarea>
