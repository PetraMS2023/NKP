    ...
    <div class="dcont">
        <div class="navCont">
            <ul class="nLinks">
                ...
                <li>
                    <a class="nLink active" href="./sub-classification.php">
                        <i class="fa-solid fa-boxes-stacked"></i>
                        التصنيفات الفرعية
                    </a>
                </li>
        ...
        <div class="mainCont" id="main">
            ...
            <div class="pageCont">
                <div class="conta p30">
                    <h3> اضافة تصنيف فرعي </h3>
                    <div class="btns">
                        <a href="./add-sub-classification.php" class="saveBtn">اضافة تصنيف فرعي +</a>
                    </div>
                </div>
                <div class="conta p30">
                    <form class="taIn">
                    ...
                    $sql = "SELECT s.id, s.subcategory_image, s.subcategory_name_ar, s.subcategory_name_en, c.category_name_ar AS main_category_name
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            echo '<tr>
                                    <td><img src="' . htmlspecialchars($row["subcategory_image"]) . '" alt=""></td>
                                    <td class="mw200">' . htmlspecialchars($row["subcategory_name_ar"]) . '</td>
                                    <td class="mw200">' . htmlspecialchars($row["subcategory_name_en"]) . '</td>
                                    <td class="mw200">' . htmlspecialchars($row["main_category_name"]) . '</td>
                                    <td class="tools">
                                        <a href="edit-sub-classification.php?id=' . $row["id"] . '">
                                            <img src="../media/icons/edit.png" alt="" id="edit">
                                        </a>
                                        <a href="../../backend/forms/delete_subcategory.php?id=' . $row["id"] . '" onclick="return confirm(\'هل أنت متأكد أنك تريد حذف هذا التصنيف الفرعي؟\')">
                                            <img src="../media/icons/delete.png" alt="">
                                        </a>
                                    </td>
                                </tr>';
                        }
