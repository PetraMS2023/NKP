    ...
    <div class="mainCont" id="main">
      ...
      <div class="pageCont">
        ...
        <div class="conta p30">
          ...
          $sql = "SELECT email, phone, location_ar, location_en FROM company_contact WHERE id = 1"; // افتراض أن هناك سجل واحد فقط في الجدول
          ...
          <form class="inputs" method="POST" action="../../backend/data/update_contact.php">
              <div class="input">
                  <span>البريد الالكتروني :</span>
                  <input type="text" name="email" spellcheck="false" placeholder="البريد الالكتروني" value="<?php echo $email; ?>">
              </div>
              <div class="input">
                  <span>رقم الهاتف :</span>
                  <input type="text" name="phone" spellcheck="false" placeholder="رقم الهاتف" value="<?php echo $phone; ?>">
              </div>
              <div class="input">
                  <span>موقع الشركة باللغة العربية :</span>
                  <input type="text" name="location_ar" spellcheck="false" placeholder="موقع الشركة باللغة العربية" value="<?php echo $location_ar; ?>">
              </div>
              <div class="input">
                  <span>موقع الشركة باللغة الانجليزية :</span>
                  <input type="text" name="location_en" spellcheck="false" placeholder="موقع الشركة باللغة الانجليزية" value="<?php echo $location_en; ?>">
              </div>
