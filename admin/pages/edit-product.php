            ...
            <div class="pageCont">
                ...
                <div class="conta p30">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $sql = "SELECT product_name_ar, product_name_en, product_specs, main_category_id, subcategory_id, product_image FROM products WHERE id = $id";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            $product_name_ar = $product_name_en = $product_specs = $product_image = "";
                            $main_category_id = $subcategory_id = 0;
                        }
                    } else {
                        $product_name_ar = $product_name_en = $product_specs = $product_image = "";
                        $main_category_id = $subcategory_id = 0;
                    ...
                    <form class="inputs" method="POST" action="../../backend/update/update_product.php"
                        ...
                        <div class="input">
                            ...
                            <select name="subcategory_id" id="">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo '<option value="' . $row["id"] . '"' . ($row["id"] == $subcategory_id ? ' selected' : '') . '>' . $row["subcategory_name_ar"] . '</option>';
                                    }
                                } else {
