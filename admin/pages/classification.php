...
<body>
    ...
    <div class="dcont">
        ...
        <div class="mainCont" id="main">
            ...
            <div class="pageCont">
                <div class="conta p30">
                    <h3> اضافة تصنيف رئيسي </h3>
                    <div class="btns">
                        <a href="./add-classification.php" class="saveBtn">اضافة تصنيف رئيسي +</a>
                    </div>
                </div>
                <div class="conta p30">
                    <form class="taIn">
                ...
                $sql = "SELECT id, category_image, category_description_ar, category_description_en FROM categories";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        echo '<tr>
                                <td><img src="' . htmlspecialchars($row["category_image"]) . '" alt=""></td>
                                <td class="mw200">' . htmlspecialchars($row["category_description_ar"]) . '</td>
                                <td class="mw200">' . htmlspecialchars($row["category_description_en"]) . '</td>
                                <td class="tools">
                                    <a href="./edit-classification.php?id=' . $row["id"] . '">
                                        <img src="../media/icons/edit.png" alt="" id="edit">
                                    </a>
                                    <a href="../../backend/forms/delete_category.php?id=' . $row["id"] . '" onclick="return confirm(\'هل أنت متأكد أنك تريد حذف هذا التصنيف؟\')">
