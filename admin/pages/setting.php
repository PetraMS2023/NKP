    ...
    <div class="dcont">
        ...
        <div class="mainCont" id="main">
            ...
            <div class="pageCont">
                ...
                $sql = "SELECT id, image_path FROM slider_images";
                ...
                <form class="inputs" method="POST" action="../../backend/data/update_slider.php" enctype="multipart/form-data">
                    <div class="s">
                        <div class="input">
                            <label for="file">صور السلايدر في الصفحة الرئيسية</label>
                            <div class="customInput">
                                <input type="file" name="slider_images[]" accept="image/*" hidden id="file" multiple>
                ...
                <table class="tg">
                    ...
                    <tbody>
                        <?php foreach ($slider_images as $image) { ?>
                            <tr>
                                <td class="mw200"><?php echo htmlspecialchars($image['id']); ?></td>
                                <td><img src="<?php echo htmlspecialchars($image['image_path']); ?>" alt=""></td>
                                <td class="tools">
                                    <a href="../../backend/data/delete_slider_image.php?id=<?php echo $image['id']; ?>" onclick="return confirm('هل أنت متأكد أنك تريد حذف هذه الصورة؟')">
...
function removeImg(element) {
    var imageName = element.getAttribute('data-name');
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "delete_slider_image.php", true);
