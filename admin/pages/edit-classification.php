    ...
    <div class="dcont">
        <div class="navCont">
            <ul class="nLinks">
                ...
                <li>
                    <a class="nLink active" href="./classification.php">
                ...
                <li>
                    <a class="nLink" href="./product.php">
        ...
        <div class="mainCont" id="main">
            ...
            <div class="pageCont">
                <div class="conta p30">
                    <h3> تعديل التصنيفات الرئيسية </h3>
                </div>
                <div class="conta p30">
                    <?php
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $sql = "SELECT brand_name_ar, brand_name_en, category_name_ar, category_name_en, category_description_ar, category_description_en, category_image FROM categories WHERE id = $id";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            $category_description_ar = $row['category_description_ar'];
                            $category_description_en = $row['category_description_en'];
                            $category_image = $row['category_image'];
                        } else {
                            echo "No record found";
                            $brand_name_ar = $brand_name_en = $category_name_ar = $category_name_en = $category_description_ar = $category_description_en = $category_image = "";
                        }
                    } else {
                        $brand_name_ar = $brand_name_en = $category_name_ar = $category_name_en = $category_description_ar = $category_description_en = $category_image = "";
                    }
                    ...
                    <form class="inputs" method="POST" action="../../backend/update/update_category.php"
                        enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <div class="input">
                            <span>اسم العلامة التجارية باللغة العربية :</span>
                            <input type="text" name="brand_name_ar" spellcheck="false"
                                placeholder="اسم العلامة التجارية باللغة العربية" value="<?php echo $brand_name_ar; ?>">
                        </div>
                        <div class="input">
                            <span>اسم العلامة التجارية باللغة الانجليزية :</span>
                            <input type="text" name="brand_name_en" spellcheck="false"
                                placeholder="اسم العلامة التجارية باللغة الانجليزية"
                                value="<?php echo $brand_name_en; ?>">
                        </div>
                        <div class="input">
                            <span>اسم التصنيف باللغة العربية :</span>
                            <input type="text" name="category_name_ar" spellcheck="false"
                                placeholder="اسم التصنيف باللغة العربية" value="<?php echo $category_name_ar; ?>">
                        </div>
                        <div class="input">
                            <span>اسم التصنيف باللغة الانجليزية :</span>
                            <input type="text" name="category_name_en" spellcheck="false"
                                placeholder="اسم التصنيف باللغة الانجليزية" value="<?php echo $category_name_en; ?>">
                        </div>
                        <div class="input">
                            <span>وصف التصنيف باللغة العربية :</span>
                            <input type="text" name="category_description_ar" spellcheck="false"
                                placeholder="وصف التصنيف باللغة العربية"
                                value="<?php echo $category_description_ar; ?>">
                        </div>
                        <div class="input">
                            <span>وصف التصنيف باللغة الانجليزية :</span>
                            <input type="text" name="category_description_en" spellcheck="false"
                                placeholder="وصف التصنيف باللغة الانجليزية"
                                value="<?php echo $category_description_en; ?>">
                        </div>
                        <div class="input">
                            ...
                            <div class="customInput">
                                ...
                                <input type="file" name="category_image" accept="image/*" hidden id="file">
